...
int WATER_SENSOR_PIN = 2; //analog pin 2 aka A2
...
void setup()
{
  ...
  Serial.println("When the temperature changes the Sensor board should blink, and print the temperature's value in C ");
...
void loop()
{
  ...
  if (sensor.update())
  {
    ...
    char radiopacket[PACKET_LENGTH];

    sprintf(radiopacket,"%d,%d",temp, waterlevel);
